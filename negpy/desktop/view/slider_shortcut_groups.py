...
SLIDER_GROUPS: tuple[SliderShortcutGroup, ...] = (
    ...
    _g("preflash", "Preflash ↑/↓", "preflash_inc", "preflash_dec", 0.01, "Exposure"),
    ...
    _g("white_point", "White point ↑/↓", "white_point_inc", "white_point_dec", 0.01, "Exposure"),
    _g("black_point", "Black point ↑/↓", "black_point_inc", "black_point_dec", 0.01, "Exposure"),
