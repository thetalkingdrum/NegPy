...
The sliders, toggles, dropdowns and one-shot actions you reach for most, gathered in
one place, so a routine edit no longer costs a tab switch and a scroll. Empty until you
fill it.
